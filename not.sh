...
make O=/home/skye/bomb/out ARCH=arm64 LLVM=1 LLVM_IAS=1 "${MAKE_OPT[@]}" vendor/kona-perf_defconfig vendor/samsung/kona-sec-common.config vendor/samsung/x1q.config vendor/kali.config
